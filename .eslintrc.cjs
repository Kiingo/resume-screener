module.exports = {
  ...
  plugins: ['@typescript-eslint', 'prettier', 'filename-rules', 'jest'],
  extends: [
    'eslint:recommended',
  ...
  rules: {
    ...
    '@typescript-eslint/no-use-before-define': [
      'warn',
      { ignoreTypeReferences: true, typedefs: false, classes: false }
    ],
    ...
    eqeqeq: ['warn', 'smart'],
    'no-console': 'warn',
    'prettier/prettier': ['error'], // Error on prettier issues
    semi: [2, 'always'],
